...
function SplitPanel() {
  return (
    <div className="split-panel">
      ...
      <UserPill letter="B" name="Jessica"   amount="$110.25"  avatarBg="#E3F5ED" letterColor="#22A55B" />
      <UserPill letter="C" name="Jarisse" amount="$91.50" avatarBg="#F0EBF8" letterColor="#9B59B6" />
